...
```{r chaid-tree, fig.height = 300, fig.width = 80}
ggparty(chaid_tree, horizontal = TRUE) +
    ...
    geom_node_plot(gglist = list(
        ...
        coord_flip(),
        theme_minimal(base_family = "arial", base_size = 60),
...
```{r rule1}
rule <- (dat$mut_type == "H-H" & dat$regions == "R2")
...
```{r rule2}
idx <- (dat$autm == "A1" & dat$autm == "A2" & dat$cube == "TGCA")
dat[ idx, ]
```
